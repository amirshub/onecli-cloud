...
- Please search [existing issues](https://github.com/amirshub/onecli-cloud/issues) before creating a new one.
...
- If you're new, we encourage you to take a look at issues tagged with [good first issue](https://github.com/amirshub/onecli-cloud/labels/good%20first%20issue).
- If you're submitting a new feature, please open an [issue](https://github.com/amirshub/onecli-cloud/issues/new) first to discuss it before opening a PR.
